...
def _db():
    import sqlite3
    _is_cloud_local = os.environ.get("RENDER") or os.environ.get("RAILWAY_ENVIRONMENT")
    DB = "/tmp/smarthire.db" if _is_cloud_local else os.path.join(os.path.dirname(__file__), "smarthire.db")
